...
import { getSiteSettings, getSiteImages, getAboutPage } from '@/lib/cms';
    ...
    <div className="cursor-light">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 animate-fade-in">
          <h1 className="text-5xl md:text-7xl font-serif text-cream mb-6 animate-slide-up">
            {settings.siteName || 'Elisa Antoniello'}
          </h1>
          <p className="text-xl md:text-2xl text-cream/90 mb-4 animate-slide-up animate-delay-100">
            Scenic Design Student
          </p>
          <p className="text-lg text-cream/80 mb-12 max-w-2xl mx-auto animate-slide-up animate-delay-200">
            {settings.tagline || 'Teatro alla Scala Academy · Lighting · Audio · Photography'}
          </p>
          
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-up animate-delay-300">
            <a
              href={`https://wa.me/${settings.whatsapp}?text=Ciao!%20Vorrei%20avere%20qualche%20informazione.`}
              target="_blank"
        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="text-lg text-stone-700 mb-6 leading-relaxed">
                {aboutData.bio?.substring(0, 300) || "I'm a passionate scenic design student at the prestigious Teatro alla Scala Academy in Milan..."}
              </div>
